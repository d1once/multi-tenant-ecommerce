...
import { formatCurreny, generateTenantURL } from "@/lib/utils";
...
export const ProductView = ({ productId, tenantSlug }: Props) => {
  ...
  return (
    <div className="px-4lg:px-12 py-10">
      <div className="border rounded-sm bg-white overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-6">
          <div className="col-span-4">
            ...
            <div className="block lg:hidden px-6 py-4 items-center justify-center border-bottom">
              <div className="flex items-center gap-1">
                <StarRating rating={3} iconClassName="size-4" />
